...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      />
       {/* <News setProgress = {this.setProgress} pageSize={this.pageSize} country="in" category="health"/> */}
       <Routes>

          <Route exact path="/About" element={<News setProgress = {this.setProgress} key="About" pageSize={this.pageSize} country="in" category="About"/>}></Route>
